...
export interface CatalistLocatorInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "accountingOracle",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "burner", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "coreComponents",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "depositSecurityModule",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "elRewardsVault",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "legacyOracle",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "catalist", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "oracleDaemonConfig",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "oracleReportComponentsForCatalist",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "oracleReportSanityChecker",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "postTokenRebaseReceiver",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "stakingRouter",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "treasury", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "validatorsExitBusOracle",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CatalistLocator extends BaseContract {
  ...
  functions: {
    ...
    oracleReportComponentsForCatalist(
      overrides?: CallOverrides
