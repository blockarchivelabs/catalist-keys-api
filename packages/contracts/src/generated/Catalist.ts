...
export interface CatalistInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getSharesByPooledAce",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getTotalPooledAce",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getBufferedAce",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getPooledAceByShares",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getEIP712StACE",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getDepositableAce",
    values?: undefined
  ): string;
...
export type ACEDistributedEvent = TypedEvent<
...
export type ACEDistributedEventFilter = TypedEventFilter<ACEDistributedEvent>;
...
export type CatalistLocatorSetEvent = TypedEvent<
  [string],
  { catalistLocator: string }
>;

export type CatalistLocatorSetEventFilter =
  TypedEventFilter<CatalistLocatorSetEvent>;
...
export type EIP712StACEInitializedEvent = TypedEvent<
  [string],
  { eip712StACE: string }
>;

export type EIP712StACEInitializedEventFilter =
  TypedEventFilter<EIP712StACEInitializedEvent>;
...
export interface Catalist extends BaseContract {
  ...
  functions: {
    ...
    getSharesByPooledAce(
      _aceAmount: BigNumberish,
  ...
  filters: {
    ...
    "ACEDistributed(uint256,uint256,uint256,uint256,uint256,uint256)"(
      reportTimestamp?: BigNumberish | null,
      preCLBalance?: null,
      postCLBalance?: null,
      withdrawalsWithdrawn?: null,
      executionLayerRewardsWithdrawn?: null,
      postBufferedAce?: null
    ): ACEDistributedEventFilter;
    ACEDistributed(
      reportTimestamp?: BigNumberish | null,
      preCLBalance?: null,
      postCLBalance?: null,
    ...
    "CatalistLocatorSet(address)"(
      catalistLocator?: null
    ): CatalistLocatorSetEventFilter;
    ...
    "EIP712StACEInitialized(address)"(
      eip712StACE?: null
    ): EIP712StACEInitializedEventFilter;
    EIP712StACEInitialized(
      eip712StACE?: null
    ): EIP712StACEInitializedEventFilter;
