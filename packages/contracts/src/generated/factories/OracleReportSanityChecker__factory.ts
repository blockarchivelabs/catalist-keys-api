...
import type {
  ...
  OracleReportSanityCheckerInterface,
  LimitsListStruct,
} from "../OracleReportSanityChecker";
...
const _abi = [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "uint256",
        name: "_aceLockedOnWithdrawalQueue",
        type: "uint256",
      },
      {
        internalType: "uint256",
...
export class OracleReportSanityChecker__factory {
  static readonly abi = _abi;
  static createInterface(): OracleReportSanityCheckerInterface {
    return new utils.Interface(_abi) as OracleReportSanityCheckerInterface;
  }
  static connect(
    address: string,
