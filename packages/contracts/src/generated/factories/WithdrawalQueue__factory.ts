...
const _abi = [
  ...
  {
    inputs: [],
    name: "MAX_BACE_WITHDRAWAL_AMOUNT",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  {
    inputs: [],
    name: "MIN_BACE_WITHDRAWAL_AMOUNT",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "getClaimableAce",
    outputs: [
      {
        internalType: "uint256[]",
        name: "claimableAceValues",
        type: "uint256[]",
      },
    ],
    stateMutability: "view",
  ...
  },
  {
    ...
    name: "requestWithdrawalsWbACEWithPermit",
    outputs: [
      {
        internalType: "uint256[]",
        name: "requestIds",
...
export class WithdrawalQueue__factory {
  static readonly abi = _abi;
  static createInterface(): WithdrawalQueueInterface {
    return new utils.Interface(_abi) as WithdrawalQueueInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): WithdrawalQueue {
    return new Contract(address, _abi, signerOrProvider) as WithdrawalQueue;
  }
}
