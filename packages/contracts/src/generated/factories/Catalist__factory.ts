...
export class Catalist__factory {
  static readonly abi = _abi;
  static createInterface(): CatalistInterface {
    return new utils.Interface(_abi) as CatalistInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Catalist {
    return new Contract(address, _abi, signerOrProvider) as Catalist;
  }
}
