...
const _abi = [
  ...
  },
  {
    ...
    name: "StakingRouterACEDeposited",
    type: "event",
  },
  {
    anonymous: false,
...
export class StakingRouter__factory {
  static readonly abi = _abi;
  static createInterface(): StakingRouterInterface {
    return new utils.Interface(_abi) as StakingRouterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StakingRouter {
    return new Contract(address, _abi, signerOrProvider) as StakingRouter;
  }
}
