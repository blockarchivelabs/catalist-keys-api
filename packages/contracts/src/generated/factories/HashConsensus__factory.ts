...
export class HashConsensus__factory {
  static readonly abi = _abi;
  static createInterface(): HashConsensusInterface {
    return new utils.Interface(_abi) as HashConsensusInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HashConsensus {
    return new Contract(address, _abi, signerOrProvider) as HashConsensus;
  }
}
