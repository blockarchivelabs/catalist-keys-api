...
export type NodeOperatorActiveSetEvent = TypedEvent<
  [BigNumber, boolean],
  { nodeOperatorId: BigNumber; active: boolean }
>;
...
export type NodeOperatorNameSetEvent = TypedEvent<
  [BigNumber, string],
  { nodeOperatorId: BigNumber; name: string }
>;
...
export type NodeOperatorRewardAddressSetEvent = TypedEvent<
  [BigNumber, string],
  { nodeOperatorId: BigNumber; rewardAddress: string }
>;
...
export type NodeOperatorTotalKeysTrimmedEvent = TypedEvent<
  [BigNumber, BigNumber],
  { nodeOperatorId: BigNumber; totalKeysTrimmed: BigNumber }
>;
...
export type RewardsDistributedEvent = TypedEvent<
  [string, BigNumber],
  { rewardAddress: string; sharesAmount: BigNumber }
>;
...
export type VettedSigningKeysCountChangedEvent = TypedEvent<
  [BigNumber, BigNumber],
  { nodeOperatorId: BigNumber; approvedValidatorsCount: BigNumber }
>;
...
export type DepositedSigningKeysCountChangedEvent = TypedEvent<
  [BigNumber, BigNumber],
  { nodeOperatorId: BigNumber; depositedValidatorsCount: BigNumber }
>;
...
export type ExitedSigningKeysCountChangedEvent = TypedEvent<
  [BigNumber, BigNumber],
  { nodeOperatorId: BigNumber; exitedValidatorsCount: BigNumber }
>;
...
export type TotalSigningKeysCountChangedEvent = TypedEvent<
  [BigNumber, BigNumber],
  { nodeOperatorId: BigNumber; totalValidatorsCount: BigNumber }
>;

export type TotalSigningKeysCountChangedEventFilter =
  TypedEventFilter<TotalSigningKeysCountChangedEvent>;

export type NonceChangedEvent = TypedEvent<[BigNumber], { nonce: BigNumber }>;
...
export type TargetValidatorsCountChangedEvent = TypedEvent<
  [BigNumber, BigNumber],
  { nodeOperatorId: BigNumber; targetValidatorsCount: BigNumber }
>;
...
export type NodeOperatorPenalizedEvent = TypedEvent<
  [string, BigNumber],
  { recipientAddress: string; sharesPenalizedAmount: BigNumber }
>;
