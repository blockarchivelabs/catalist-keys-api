    ...
    getStateValidators: {
        parameters: {
            ...
            query: {
                ...
                id?: string[];
                /** [Validator status specification](https://hackmd.io/ofFJ5gOmQpu1jjHilHbdQQ) */
                status?: (('pending_initialized' | 'pending_queued' | 'active_ongoing' | 'active_exiting' | 'active_slashed' | 'exited_unslashed' | 'exited_slashed' | 'withdrawal_possible' | 'withdrawal_done') | ('active' | 'pending' | 'exited' | 'withdrawal'))[];
            };
        };
        responses: {
            /** Success */
    ...
    eventstream: {
        parameters: {
            query: {
                ...
                topics: ('head' | 'block' | 'attestation' | 'voluntary_exit' | 'finalized_checkpoint' | 'chain_reorg' | 'contribution_and_proof')[];
            };
        };
        responses: {
            /** Opened SSE stream. */
